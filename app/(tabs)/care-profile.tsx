...
export default function CareProfileScreen() {
    ...
    const basicsDisplayName =
        profileQuery.data?.basics?.fullName ??
        profileQuery.data?.careRecipientName ??
        'Care recipient';
    ...
    return (
        <View className="flex flex-1 bg-surface dark:bg-surface-dark">
            ...
            <Container className="px-4 pb-8 pt-4">
                ...
                <View className="gap-3">
                    ...
                    {placeholderCard(
                        ...
                        'Structured provider list is coming soon.'
                    )}
            ...
            <Modal
                ...
                transparent
                animationType="fade"
                onRequestClose={() => setIsBasicsOpen(false)}
                statusBarTranslucent>
                <Pressable
                    className="flex-1 items-center justify-center bg-black/40 px-6"
                    onPress={() => setIsBasicsOpen(false)}>
                    <Pressable
                        onPress={() => {}}
                        ...
                        <View className="gap-3">
                            <TextInput
                                ...
                                onChangeText={(text) =>
                                    setBasicsDraft((prev) => ({ ...prev, fullName: text }))
                                }
                            ...
                            <TextInput
                                ...
                                onChangeText={(text) =>
                                    setBasicsDraft((prev) => ({ ...prev, notes: text }))
                                }
                                placeholder="Notes"
                                multiline
                                numberOfLines={4}
                    ...
                    <Pressable
                        ...
                        <View className="gap-3">
                            <TextInput
                                ...
                                onChangeText={(text) =>
                                    setContactDraft((prev) => ({ ...prev, name: text }))
                                }
                                placeholder="Name"
                                className="rounded-xl border border-border bg-white px-3 py-2 text-sm dark:border-border-dark dark:bg-surface-dark dark:text-text-dark"
                            />
                            ...
                            <TextInput
                                ...
                                onChangeText={(text) =>
                                    setContactDraft((prev) => ({ ...prev, phone: text }))
                                }
                                placeholder="Phone"
                                className="rounded-xl border border-border bg-white px-3 py-2 text-sm dark:border-border-dark dark:bg-surface-dark dark:text-text-dark"
                            />
                            <TextInput
                                ...
                                onChangeText={(text) =>
                                    setContactDraft((prev) => ({ ...prev, email: text }))
                                }
                                placeholder="Email"
                                autoCapitalize="none"
                            ...
                            <TextInput
                                ...
                                onChangeText={(text) =>
                                    setContactDraft((prev) => ({ ...prev, address: text }))
                                }
                                placeholder="Address"
                                className="rounded-xl border border-border bg-white px-3 py-2 text-sm dark:border-border-dark dark:bg-surface-dark dark:text-text-dark"
                            />
                        ...
                        <View className="mt-4 flex-row justify-end gap-3">
                            ...
                            <Pressable
                                ...
                                style={({ pressed }) => ({
                                    opacity:
                                        upsertContact.isPending || !contactDraft.name.trim()
                                            ? 0.5
                                            : pressed
                                              ? 0.85
                                              : 1,

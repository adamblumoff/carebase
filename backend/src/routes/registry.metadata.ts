...
export const ROUTER_METADATA: RouterMeta[] = [
  ...
  { basePath: '/api/medications', scope: 'api', description: 'Medication management APIs' },
  ...
  { basePath: '/api/review', scope: 'api', description: 'Pending item review APIs' },
...
export const API_ROUTE_METADATA: RouteMeta[] = [
  ...
  { method: 'GET', path: '/api/medications', description: 'List medications for the active recipient' },
  { method: 'POST', path: '/api/medications', description: 'Create a medication and optional doses' },
  { method: 'GET', path: '/api/medications/:id', description: 'Fetch medication with doses and intake summaries' },
  { method: 'PATCH', path: '/api/medications/:id', description: 'Update medication fields' },
  { method: 'PATCH', path: '/api/medications/:id/archive', description: 'Archive a medication' },
  { method: 'PATCH', path: '/api/medications/:id/unarchive', description: 'Unarchive a medication' },
  { method: 'POST', path: '/api/medications/:id/doses', description: 'Create a medication dose' },
  { method: 'PATCH', path: '/api/medications/:id/doses/:doseId', description: 'Update a medication dose' },
  { method: 'DELETE', path: '/api/medications/:id/doses/:doseId', description: 'Delete a medication dose' },
  { method: 'POST', path: '/api/medications/:id/intakes', description: 'Record a medication intake event' },
  { method: 'PATCH', path: '/api/medications/:id/intakes/:intakeId', description: 'Update medication intake status' },
  { method: 'POST', path: '/api/medications/:id/refill', description: 'Set medication refill projection' },
  { method: 'DELETE', path: '/api/medications/:id/refill', description: 'Clear medication refill projection' },
  { method: 'POST', path: '/api/upload/photo', description: 'Upload bill photo for OCR + ingestion' },
  { method: 'GET', path: '/api/review/pending', description: 'List pending items requiring manual review' },
  { method: 'PATCH', path: '/api/review/:itemId', description: 'Take action on a pending review item (approve/save/reject)' },
